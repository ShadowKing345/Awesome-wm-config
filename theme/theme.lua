...
theme.cairo_fonts = {
  ...
  desktop = {textbox = {font = "Sans", size = 22, face = 0}},
}
...
function theme:init()
  ...
  self.widget.minitray = {
    ...
    set_position = function(wibox)
      local geometry = {x = mouse.screen.workarea.x + mouse.screen.workarea.width, y = mouse.screen.workarea.y}
  ...
  self.widget.tasklist.winmenu = {
    ...
    tagmenu = {width = 150, color = {right_icon = self.color.icon, left_icon = self.color.icon}, icon_margin = {9, 9, 9, 9}},
  ...
  ------------------------------------------------------------
  self.float.player = {
    geometry = {width = 520, height = 150}, -- widget size
    screen_gap = 2 * self.useless_gap, -- minimal space from screen edge on floating widget placement
  ...
  self.float.player.icon = {
    ...
    next_py = self.base .. "/player/right.svg",
    prev_py = self.base .. "/player/left.svg",
  ...
  self.float.top = {
    ...
    -- placement function
    set_position = function(wibox)
      local geometry = {x = mouse.screen.workarea.x + mouse.screen.workarea.width, y = mouse.screen.workarea.y + mouse.screen.workarea.height}
  ...
  self.float.appswitcher = {
    ...
    parser = {desktop_file_dirs = awful.util.table.join(self.service.dfparser.desktop_file_dirs, {"~/.local/share/applications-fake"})},
  ...
  self.float.appswitcher.hotkeys = {
    "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12",
  }
  ...
  ------------------------------------------------------------
  self.float.hotkeys = {
    geometry = {width = 1800}, -- widget size
  ...
  self.float.control = {
    ...
    -- widget icons
    icon = {onscreen = self.wicon.onscreen, resize = {self.wicon.resize.full, self.wicon.resize.horizontal, self.wicon.resize.vertical}},
