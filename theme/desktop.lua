...
function desktop.new(args)
  ...
  desktop.color = {main = color.main, gray = color.desktop_gray, icon = color.desktop_icon, urgent = color.urgent, wibox = color.bg .. "00"}
  ...
  return {
    ...
    grid = {width = {420, 1000, 420}, height = {210, 210, 210}, edge = {width = {40, 40}, height = {40, 40}}},

    places = {clock = {3, 1}, netspeed = {1, 3}, player = {3, 3}},
