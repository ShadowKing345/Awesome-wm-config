...
void pa_get_sinks_cb(pa_context *context, const pa_sink_info *info, int eol, void *userdata);

void pa_get_sink_input_cb(pa_context *context, const pa_sink_input_info *info, int eol, void *userdata);

void pa_get_sources_cb(pa_context *context, const pa_source_info *info, int eol, void *userdata);

void pa_get_source_outputs_cb(pa_context *context, const pa_source_output_info *info, int eol, void *userdata);
